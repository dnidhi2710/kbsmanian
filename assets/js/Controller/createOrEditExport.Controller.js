app.controller('createOrEditExportController', ['$scope', '$location', '$window', '$http', '$routeParams', 'usSpinnerService', 'commonService', '$filter', 'dbConfigService',
    function ($scope, $location, $window, http, $routeParams, spinner, commonService, $filter, configSevice) {
        ...
        $scope.doc.exportType = 'Air';
        $scope.exportTypeCode = 'exportAir';
        ...
        function init() {
            ...
            var url = configSevice.getUrl() + "export_air_sea/export_air_sea.php";
