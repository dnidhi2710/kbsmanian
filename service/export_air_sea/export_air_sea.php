...
function create_export_doc() {
   ...
   // $array1['par_status'] = PAR_DEFAULT_STATUS;
    ...
    $dbresult = $db->insertOperation('export_air_sea',$array1);
	...
	function update_export_doc(){
	   ...
	   $dbResult1 = $db->updateOperation('export_air_sea',$array1,$wherearray);
...
function view_export_doc(){
    global $db,$request;
       ...
       // echo "called";
		$select = "SELECT * from export_air_sea WHERE impJobId = '".$request['id']."' ";
